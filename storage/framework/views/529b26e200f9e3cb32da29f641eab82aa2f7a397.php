		...
		<?php if($options->type == 'belongsTo'): ?>
			...
			<?php else: ?>
				...
				<select class="form-control select2" name="<?php echo e($options->column); ?>">
					...
					<?php if($row->field == 'product_belongsto_product_label_relationship'): ?>
		...
		<?php elseif($options->type == 'belongsToMany'): ?>
			...
			<?php else: ?>
				<select
					...
					name="<?php echo e($relationshipField); ?>[]" multiple required
				...
				>
						...
						<!--<?php if($row->required === 0): ?>
							<option value=""><?php echo e(__('voyager::generic.none')); ?></option>
						<?php endif; ?>-->
						<?php if($relationshipField == 'product_belongstomany_subcategory_relationship'): ?>
								...
								<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<optgroup label="<?php echo e($category->name); ?>">
										<?php $__currentLoopData = $relationshipOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationshipOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if($relationshipOption->category == $category->id): ?>
							...
							<?php else: ?>
								...
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php endif; ?>
						<?php elseif($relationshipField == 'product_belongstomany_subcategory_relationship_1'): ?>
							<?php if(isset($categories)): ?>
								<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<optgroup label="<?php echo e($category->name); ?>">
										<?php $__currentLoopData = $relationshipOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationshipOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
