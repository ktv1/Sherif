                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions" style="display: flex; flex-direction: row-reverse;">
                                            <?php $__currentLoopData = Voyager::actions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($action == 'TCG\Voyager\Actions\ViewAction'): ?>
                                                    <?php  continue;  ?>
                                                <?php elseif(in_array('В наличии' || 'Нет в наличии' || 'На складе' || 'Ожидается поставка' || 'Снят с производства',$statuses_arr)): ?>
                                                    <?php if($action == 'TCG\Voyager\Actions\DeleteAction'): ?>
                                                        <?php  continue;  ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>
