...
<?php $__env->startSection("main_column"); ?>
    ...
    <div class="sherif_center_column">
        ...
        <!--SHERIF CABINET-->
        <input id="user_id" type="hidden" value="<?php echo e($user->id); ?>">
            ...
            <div class="tabs">
                ...
                <div class="tab-content">
                        ...
                        <div class="sherif_main-box_cabinet_profile">
                            <div class="cabinet_profile_user">
                                <img id="span_img"
                                     ...
                                     src="<?php echo e(!empty($user->avatar) ?
                                            asset('/storage/cache/175x175_' . $user->avatar) :
                                            asset('/assets/img/pic/cabinet/user.png')); ?>"
                                     alt="<?php echo e($user->name); ?> <?php echo e($user->lastname); ?>"
                                >
                                <span id="span_name" class="cabinet_profile_user_data"><?php echo e($user->name); ?> <?php echo e($user->lastname); ?></span>

                                <div class="cabinet_profile_info_data">
                                    <span class="col-sm-6 text-right">Телефон:</span>
                                    <span class="text-primary"><?php echo e($user->phone); ?></span>
                                </div>
                                <div class="cabinet_profile_info_data">
                            ...
                            <div class="cabinet_profile_info">
                                ...
                                <div class="social-cabinet flex-row">
                                    <a href="#"><img src="<?php echo e(asset('/assets/img/footer/icons/fb.png')); ?>" alt=""></a>
                                    <a href="#"><img src="<?php echo e(asset('/assets/img/footer/icons/you-tube.png')); ?>" alt=""></a>
                                    <a href="#"><img src="<?php echo e(asset('/assets/img/footer/icons/inst.png')); ?>" alt=""></a>
                                </div>
                                ...
                                <div class="cabinet_profile_info_data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!isset($user->userpersonal->sex) ? 'Не указан' : $user->userpersonal->sex == 'M' ? 'Мужчина' : 'Женщина'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!empty($user->userpersonal->datebirth) ? $user->userpersonal->datebirth : 'Не указано'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!empty($user->userpersonal->obl) ? $user->userpersonal->obl : 'Не указано'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!empty($user->userpersonal->city) ? $user->userpersonal->city : 'Не указано'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!empty($user->userpersonal->street) ? $user->userpersonal->street : 'Не указано'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!empty($user->userpersonal->house) ? $user->userpersonal->house : 'Не указано'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 text-primary">
                                            <?php echo e(!empty($user->userpersonal->apartment) ? $user->userpersonal->apartment  : 'Не указано'); ?>
                                ...
                                <div class="panel-heading cabinet_orders">
                                    ...
                                    <div class="cabinet_orders_content">
                                        <div class="cabinet_orders_content_data">
                                            <img class="cabinet_orders_content_data_img" src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="">
                                    ...
                                    <div class="cabinet_orders_content">
                                        <div class="cabinet_orders_content_data_complex">
                                            <div class="cabinet_orders_content_data_complex_img">
                                                <img class="cabinet_orders_content_data_img_complex" src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="">
                                                <img class="cabinet_orders_content_data_img_complex" src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="">
                                                <img class="cabinet_orders_content_data_img_complex" src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="">
                                                <img class="cabinet_orders_content_data_img_complex" src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="">
                                            </div>
                    ...
                    <div class="tab-pane fade in" id="tab-7">
                        <?php echo $__env->make('frontend.account.partials.reviews', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
        <!--SHERIF CABINET END-->
        <?php $__env->startComponent('frontend.account.modal-account-edit'); ?>

        <?php $__env->slot('name', 'user-modal'); ?>
            <?php $__env->slot('title', 'Редактирование персональных данных'); ?>
                <div class="form-group col-sm-12">
                    <label for="inputImg">Аватар</label>
                    <?php if(!empty($user) && !empty($user->avatar)): ?>
                        <br />
                        <img src="" alt="">
                    <?php endif; ?>
            ...
            <div class="form-group col-sm-4">
                ...
                <input id="user-name" class="form-control" name="name" type="text" value="<?php echo e(isset($user->name) ? $user->name : old('name')); ?>">
            </div>

            <div class="form-group col-sm-4">
                <label for="user-lastname">Фамилия</label>
                <input id="user-lastname" class="form-control" name="lastname" type="text" value="<?php echo e(isset($user->lastname) ? $user->lastname : old('lastname')); ?>">
            </div>
            <div class="form-group col-sm-4">
                <label for="user-phone">Телефон</label>
                <input id="user-phone" class="form-control" name="phone" type="text" value="<?php echo e(isset($user->phone) ? $user->phone : old('phone')); ?>">
            </div>
                <div class="form-group col-sm-6">
                    <label for="user-name">Пол</label><br/>
                    <select id="user-sex" name="sex" data-sex="" class="form-control">
                        <?php if(isset($user->userpersonal->sex)): ?>
                            <?php $__currentLoopData = $sexvalues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($value); ?>"
                                        <?php if($value == old('sex', $user->userpersonal->sex)): ?>
                                        selected="selected"
                                        <?php endif; ?>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="input-group date" id="input-datebirth">
                        <input id="user-datebirth" class="form-control" data-format="dd/MM/yyyy" name="datebirth" type="text" value="<?php echo e(isset($user->userpersonal->datebirth) ? $user->userpersonal->datebirth : old('datebirth')); ?>">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <input id="user-obl" class="form-control" name="obl" type="text" value="<?php echo e(isset($user->userpersonal->obl) ? $user->userpersonal->obl : old('obl')); ?>">
                </div>

                <div class="form-group col-sm-12">
                    <label for="user-city">Город</label>
                    <input id="user-city" class="form-control" name="city" type="text" value="<?php echo e(isset($user->userpersonal->city) ? $user->userpersonal->city : old('city')); ?>">
                </div>
                <div class="form-group col-sm-6">
                    <label for="user-street">Улица/бульвар/проулок</label>
                    <input id="user-street" class="form-control" name="street" type="text" value="<?php echo e(isset($user->userpersonal->street) ? $user->userpersonal->street : old('street')); ?>">
                </div>
                <div class="form-group col-sm-3">
                    <label for="user-apartment">Дом</label>
                    <input id="user-house" class="form-control" name="house" type="text" value="<?php echo e(isset($user->userpersonal->house) ? $user->userpersonal->house : old('house')); ?>">
                </div>
                <div class="form-group col-sm-3">
                    <label for="user-apartment">Квартира</label>
                    <input id="user-apartment" class="form-control" name="apartment" type="text" value="<?php echo e(isset($user->userpersonal->apartment) ? $user->userpersonal->apartment : old('apartment')); ?>">
                </div>
