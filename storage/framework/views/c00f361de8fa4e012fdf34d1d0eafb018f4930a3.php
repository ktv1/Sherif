...
<?php $__env->startSection("main_column"); ?>
    <div class="sherif_center_column">
        ...
        <?php echo $__env->make("frontend.module.banner", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <div class="sherif_home_main-box_brand">
            <!-- Box brand start -->
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand1.jpg')); ?>" alt="">
            </div>
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand2.jpg')); ?>" alt="">
            </div>
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand3.jpg')); ?>" alt="">
            </div>
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand4.jpg')); ?>" alt="">
            </div>
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand5.jpg')); ?>" alt="">
            </div>
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand4.jpg')); ?>" alt="">
            </div>
            ...
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand6.jpg')); ?>" alt="">
            </div>
            <div class="sherif_home_main-box_brand-brands">
                <img src="<?php echo e(asset('/assets/img/box brand/Health-brand2.jpg')); ?>" alt="">
            </div>
        ...
        <div class="sherif_home_main-mobile_bar air-show">
            <div class="sherif_home_mobile_ads">
                <a href="#" style="background-image:url(<?php echo e(asset('/assets/img/pic/Air_Show.jpg')); ?>);" class="sherif_home_main-box-right_bar-advertising-pic"  >
                </a>
                <a href="#" style="background-image:url(<?php echo e(asset('/assets/img/pic/Air_Show.jpg')); ?>);" class="sherif_home_main-box-right_bar-advertising-pic"  >
                </a>
            </div>
        ...
        <div class="sherif_home_main-mobile_bar">
            <div class="color_pick">
                <a href="#" style="background-image: url(<?php echo e(asset('/assets/img/pic/pick_up.jpg')); ?>);" class="sherif_home_main-box-right_bar-pick_up-pic">
                                ...
                                <div class="video-blog_review">
                                    <div class="video-blog_review_content">
                                        <div class="video-blog-row">
                                            <img class="video-blog_review_img" src="<?php echo e(asset('/assets/img/pic/product.png')); ?>" alt="">
