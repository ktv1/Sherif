...
<?php $__env->startSection("css_files"); ?>
    ...
    <?php endif; ?>
        loadCSS("<?php echo e(asset('assets/css/catalog/_main.css')); ?>");                
    //User Styles: Main
    <?php if($is_admin): ?>
        loadCSS("<?php echo e(asset('assets/css/_main_admin.css')); ?>");  
    //User Styles: Main
    <?php endif; ?>
        loadCSS("<?php echo e(asset('assets/css/catalog/_media.css')); ?>");  
    //User Styles: Media
    <?php if($is_admin): ?>
    ...
    <div class="sherif_center_column">
        ...
        <div class="sherif-catalog">
            <ul class="sherif-breadcrumb">
                ...
                <li><a href="#"><?php echo e($CurrentCategory->name); ?></a></li>
                <li><span>Вы здесь <i class="fas fa-arrow-right"></i></span><?php echo e($CurrentSubCategory->name); ?></li>
            </ul>

            <!-- subcategories -->
            <div class="sherif_home_main-box_section">
                <?php $__currentLoopData = $datacategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcatalog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="panel-body">
                                                <div>
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/multicam.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                    ...
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/woodland.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                    ...
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/A-TACS.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> A-TACS
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/A-TACS-AU.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> A-TACS AU
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/A-TACS-FG.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> A-TACS FG
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/ACU.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> ACU
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/MTP.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> MTP
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/mossy-oak.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                    ...
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/cadpat.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Cadpat
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/flexktarn.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Flacktarn
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/AT-Digital.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> AT-Digital
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/Digital.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Digital
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/Khaki.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Khaki
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/FG.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> FG
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/OliveDrab.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Olive Drab
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/AOR-1.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> AOR 1/2
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/desert-dpm2.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                    ...
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/ССЕTarn1.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> CCE Tarn
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/DDPM2.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> DDPM
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/tree2.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                    ...
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/dpm_urban_b_.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Urban
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/Kruptek.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Kruptek
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/Varan.png')); ?>);background-repeat: no-repeat;background-size: cover;">
                                                        <input type="checkbox" name=""> Varan
                                                    </div><br />
                                                    <div class="colors"  style="
                                                                                    background: url(<?php echo e(asset('/assets/img/pic/filter/MARPAT.png')); ?>);background-repeat: no-repeat;background-size: cover;">
            ...
            <div class="sherif-catalog_sort">
                ...
                <div class="sherif-catalog_sort_look">
                    <a href="#"><img src="<?php echo e(asset('/assets/img/icons/th-large-solid.svg')); ?>"></a>
                    <a href="#"><img src="<?php echo e(asset('/assets/img/icons/th-solid.svg')); ?>"></a>
                    <a href="#"><img src="<?php echo e(asset('/assets/img/icons/bars-solid.svg')); ?>"></a>
                </div>
            </div>
                ...
                <div class="sherif_catalog_content">
                        ...
                        <div class="sherif-product">
                            <div class="sherif-product_content">
                                ...
                                <div class="sherif-product_content-img_box">
                                    ...
                                    ?>
                                        <img class="sherif-product_content_img" src="/storage/<?php echo e(get_download_image_cache($product->mainimage,140,200)); ?>" alt="">
                                    <!--<img class="sherif-product_content_img" src="<?php echo e(asset('storage/'. $img_cropped[0] . '-cropped.' . $img_cropped[1])); ?>" alt="">-->
                                </div>
                                <a href="<?php echo e(route('product', ['slug'=>$CurrentCategory->slug, 'subslug'=>$CurrentSubCategory->slug, 'product'=>$product->slug])); ?>" class="sherif-product_content_link"><?php echo e($product->name); ?></a><br />

                                <!-- <span class="sherif-product_content_prev-price">Цена: <span class="price">870.00 грн</span></span><br /> -->
                                <span class="sherif-product_content_current-price">Цена: <span class="price"><?php echo e($product->price_final); ?> грн</span></span><br />
                            </div>
                            <div class="sherif-product-buttons notoneclick">
                                <a class="sherif-btn btn-sherif-product btn-in-basket" product-id="<?php echo e($product->id); ?>"><span></span><i class="fas fa-shopping-cart"></i><strong>В корзину</strong></a>
                    ...
                    <!-- <div class="sherif-product">
                        <div class="sherif-product_content">
                            ...
                            <div class="sherif-product_content-img_box">
                                <img class="sherif-product_content_img" src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="">
                            </div>
                    ...
                    <div class="sherif-product">
                        <div class="sherif-product_content">
                            ...
                            <div class="sherif-product_content-img_box">
                                <img class="sherif-product_content_img" src="<?php echo e(asset('/assets/img/recommended/icon3.png')); ?>" alt="">
                            </div>
                            <a href="#" class="sherif-product_content_link">Сумка-рюкзак Arm-tec тк. Cordura Digital ВСУ, 70л</a><br />
                    ...
                    <div class="sherif-product">
                        <div class="sherif-product_content">
                            ...
                            <div class="sherif-product_content-img_box">
                                <img class="sherif-product_content_img" src="<?php echo e(asset('/assets/img/recommended/icon2.png')); ?>" alt="">
                            </div>
                            <a href="#" class="sherif-product_content_link">Сумка-рюкзак Arm-tec тк. Cordura Digital ВСУ, 70л</a><br />
                    ...
                    <div class="sherif-product">
                        <div class="sherif-product_content">
                            ...
                            <div class="sherif-product_content-img_box">
                                <img class="sherif-product_content_img" src="<?php echo e(asset('/assets/img/recommended/icon4.png')); ?>" alt="">
                            </div>
                            <a href="#" class="sherif-product_content_link">Сумка-рюкзак Arm-tec тк. Cordura Digital ВСУ, 70л</a><br />
                    ...
                    <div class="sherif-product">
                        <div class="sherif-product_content">
                            ...
                            <div class="sherif-product_content-img_box">
                                <img class="sherif-product_content_img" src="<?php echo e(asset('/assets/img/recommended/icon5.png')); ?>" alt="">
                            </div>
                            <a href="#" class="sherif-product_content_link">Сумка-рюкзак Arm-tec тк. Cordura Digital ВСУ, 70л</a><br />
            ...
            <div class="sherif-catalog_bottom">
                ...
                <div id="product_pegination" class="products-pagination row">
                    <div class="">
                        <?php echo $data->appends(Request::capture()->except('page'))->render(); ?>
                ...
                <div class="sherif-catalog_sort">
                    ...
                    <div class="sherif-catalog_sort_look">
                        <img src="<?php echo e(asset('/assets//img/icons/th-large-solid.svg')); ?>">
                        <img src="<?php echo e(asset('/assets/img/icons/th-solid.svg/')); ?>">
                        <img src="<?php echo e(asset('/assets/img/icons/bars-solid.svg/')); ?>">
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->startSection("right_side_bar"); ?>
            ...
            <div class="sherif_home_main-right_bar-viewed">
                ...
                <div class="sherif_home_main-right_bar-viewed-trade_item">
                    <div class="sherif_home_main-right_bar-viewed-trade_item-pic">
                        <img src="<?php echo e(asset('/assets/img/recommended/icon2.png')); ?>" alt="" >
                    </div>
                ...
                <div class="sherif_home_main-right_bar-viewed-trade_item">
                    <div class="sherif_home_main-right_bar-viewed-trade_item-pic">
                        <img src="<?php echo e(asset('/assets/img/recommended/icon1.png')); ?>" alt="" >
                    </div>
                    <div class="sherif_home_main-right_bar-viewed-trade_item-description">
                        <div class="sherif_home_main-right_bar-viewed-trade_item-description-top">
                            <h5>Костюм Полиция нового образца, тип А </h5>
                ...
                <div class="sherif_home_main-right_bar-viewed-trade_item">
                    <div class="sherif_home_main-right_bar-viewed-trade_item-pic">
                        <img src="<?php echo e(asset('/assets/img/recommended/icon3.png')); ?>" alt="" >
                    </div>
                    <div class="sherif_home_main-right_bar-viewed-trade_item-description">
                        <div class="sherif_home_main-right_bar-viewed-trade_item-description-top">
                            <h5>Костюм Полиция нового образца, тип А </h5>
